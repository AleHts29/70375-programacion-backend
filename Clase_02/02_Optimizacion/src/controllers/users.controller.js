...
import { generateUserErrorInfo, generateUserErrorInfoENG } from "../services/errors/messages/user-creation-error.message.js";
...
export const saveUser = (req, res) => {
    ...
    if (!first_name || !email) {
        ...
        CustomError.createError({
            ...
            cause: generateUserErrorInfoENG({ first_name, last_name, age, email }),
